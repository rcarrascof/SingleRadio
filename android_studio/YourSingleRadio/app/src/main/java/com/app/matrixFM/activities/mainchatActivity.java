...
import com.app.matrixFM.adapters.GroupAdapter;
import com.app.matrixFM.adapters.MessageAdapter;
import com.app.matrixFM.models.Group;
import com.app.matrixFM.models.Message;
    ...
    protected void onCreate(Bundle savedInstanceState) {
       ...
       /* addGroupBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                final EditText txtUrl = new EditText(mainchatActivity.this);
        ...
        FirebaseDatabase database = FirebaseDatabase.getInstance("https://alofokefm-9cf3c-default-rtdb.firebaseio.com/");
